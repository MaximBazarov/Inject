...
@MainActor
final class Permanent_Local_Tests: XCTestCase {
    
    final class ClassUnderTest: Injectable {
        @Injected(\.network, lifespan: .permanent, scope: .local) var network
        @Injected(\.auth, lifespan: .permanent, scope: .local) var auth
        @Injected(\.crossDependencyA, lifespan: .permanent, scope: .local) var crossDependencyA
        @Injected(\.crossDependencyB, lifespan: .permanent, scope: .local) var crossDependencyB
    ...
    func test_Class_when_consumerDeallocates_dependencies_shouldStay() {
    ...
    func test_Actor_when_consumerDeallocates__dependencies_shouldStay() {
