...
@MainActor
final class Temporary_Shared_Tests: XCTestCase {

    final class ClassUnderTest: Injectable {
        @Injected(\.network, lifespan: .temporary, scope: .shared) var network
        @Injected(\.auth, lifespan: .temporary, scope: .shared) var auth
        @Injected(\.crossDependencyA, lifespan: .temporary, scope: .shared) var crossDependencyA
        @Injected(\.crossDependencyB, lifespan: .temporary, scope: .shared) var crossDependencyB
    ...
    func test_Class_when_consumerDeallocates_dependencies_shouldBeDeallocated() {
    ...
    func test_Class_when_consumerDeallocates_newClass_shouldHaveNewInstance() {
        var sut: ClassUnderTest? = ClassUnderTest()
    ...
    func test_Class_when_oneConsumerHasSharedDep_newClass_shouldHaveSameInstanceAsA() {
        let sutA = ClassUnderTest()

        weak var networkA = sutA.network.instance
        weak var authA = sutA.auth.instance
        weak var crossDependencyAA = sutA.crossDependencyA.instance
        weak var crossDependencyBA = sutA.crossDependencyB.instance

        let sutB = ClassUnderTest()


        weak var networkB = sutB.network.instance
        weak var authB = sutB.auth.instance
        weak var crossDependencyAB = sutB.crossDependencyA.instance
        weak var crossDependencyBB = sutB.crossDependencyB.instance

        XCTAssertEqual(id(networkA), id(networkB))
        XCTAssertEqual(id(authA), id(authB))
        XCTAssertEqual(id(crossDependencyAA), id(crossDependencyAB))
        XCTAssertEqual(id(crossDependencyBA), id(crossDependencyBB))
    }
    ...
    func test_Actor_when_consumerDeallocates_dependencies_shouldBeDeallocated() {
    ...
    func test_Actor_when_oneConsumerHasSharedDep_newActor_shouldHaveSameInstanceAsA() {
        let sutA = ActorUnderTest()
